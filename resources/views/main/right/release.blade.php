...
@include('components.release_message',['ver'=>'0.3','date'=>'2020.10.4','exp1'=>'プライバシーポリシー、しののめについてのページを更新しました','exp3'=>'あいさつページでユーザーの画像表示を追加しました','exp2'=>'プロフィールと設定で名前と自己紹介ができるようになりました','exp3'=>'','exp4'=>'',])
